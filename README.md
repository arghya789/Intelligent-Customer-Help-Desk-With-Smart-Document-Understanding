...
https://youtu.be/nXt0ezubOOk

This project is the result as a deliverable to the internship I have undergone under Smartinternz Internship Programme hoted by Smartbridge.
...
The data set being used to train the assisstant via discovery is a manual of a thermostat device ecobee3.

Node_Red Dasboard link after deploying :https://node-red-helpbot.eu-gb.mybluemix.net/ui
